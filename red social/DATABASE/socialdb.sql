...
INSERT INTO `members` (`member_id`, `firstname`, `lastname`, `middlename`, `address`, `email`, `contact_no`, `age`, `gender`, `username`, `password`, `image`, `birthdate`, `mobile`, `distrito`, `hobby`, `posicion`) VALUES
(11, 'Mauricio', 'Sevilla', '', 'Calle 45 #16-23', '', '', 0, 'Hombre', 'configuroweb', '1234abcd..', 'images/male5.png', '1992-05-02', '985062148', 'San Borja', 'juegos de mesa', 'Defensa'),
(12, 'Pedro', 'Dominguez', '', 'Calle Industrial 5', '', '', 0, 'Hombre', 'usuario', '1234abcd..', 'images/avatar.jpg', '1989-07-12', '948153480', 'Pueblo Libre', 'Juego de cartas', 'Central'),
(13, 'Juan', 'Lee', '', 'Los Jazmines Calle 8', '', '', 0, 'Hombre', 'lee', '1234abcd..', 'images/avatar.jpg', '25-12-1997', '977436890', 'Los Olivos', 'Escuchar musica clasica', 'Arquero');
